...
git clone ${CLONE_DEPTH} -b ${AML_BRANCH} https://github.com/mrudorfer/AML.git ${AML_ABS_PATH}

echo "git clone ${CLONE_DEPTH} -b ${AML_BRANCH} https://github.com/mrudorfer/AML.git ${AML_ABS_PATH}"
